...
export class EmailNotifier {
    ...
    async sendApprovalRequest(task, evaluation) {
        const subject = `🔔 Approval Required: ${task.name}`;

        const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #e67e22;">🔔 Approval Required</h2>
    ...
    async sendDailySummary(summary, questions = [], propositions = []) {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <h3 style="color: #2c3e50; margin-top: 30px;">📝 Recent Actions</h3>
        ...
        <h3 style="color: #2c3e50; margin-top: 30px;">❓ Questions for Tomorrow</h3>
        <ul>${questionsHtml}</ul>
        
        <h3 style="color: #2c3e50; margin-top: 30px;">🚀 Pre-Approval Propositions</h3>
        ${propsHtml}
